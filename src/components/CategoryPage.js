...
function CategoryPage() {
    ...
    return (
        <>
            <div style={{ position: "sticky", top: "10px", maxWidth: "100%", height: "40px", backgroundColor: "rgba(1, 1, 1, 0.63)", backdropFilter: "blur(10px)", display: "flex", padding: "10px", alignItems: "center", justifyContent: "space-between" }}>
